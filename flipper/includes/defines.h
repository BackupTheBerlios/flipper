...
#define DIFF_ASSIGN_FOR_EACH_QUADRANT_R( i , j , call ) (i) -> pQuadrant[7] = call ( (j) -> pQuadrant[7] ); (i) -> pQuadrant[6] = call ( (j) -> pQuadrant[3] ); (i) -> pQuadrant[3] = call ( (j) -> pQuadrant[5] ); (i) -> pQuadrant[2] = call ( (j) -> pQuadrant[1] ); (i) -> pQuadrant[5] = call ( (j) -> pQuadrant[6] ); (i) -> pQuadrant[4] = call ( (j) -> pQuadrant[2] ); (i) -> pQuadrant[1] = call ( (j) -> pQuadrant[4] ); (i) -> pQuadrant[0] = call ( (j) -> pQuadrant[0] ); 
