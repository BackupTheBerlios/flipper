...
#define DIFF_FOR_EACH_QUADRANT_S( i , j , call ) call ( (i) -> pQuadrant[7], (j) -> pQuadrant[7] ); call ( (i) -> pQuadrant[3], (j) -> pQuadrant[3] ); call ( (i) -> pQuadrant[5], (j) -> pQuadrant[4] ); call ( (i) -> pQuadrant[1], (j) -> pQuadrant[0] ); call ( (i) -> pQuadrant[6], (j) -> pQuadrant[7] ); call ( (i) -> pQuadrant[2], (j) -> pQuadrant[3] ); call ( (i) -> pQuadrant[4], (j) -> pQuadrant[4] ); call ( (i) -> pQuadrant[0], (j) -> pQuadrant[0] ); 
